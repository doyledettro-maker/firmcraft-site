    ...
    <AppShell>
      ...
      <Card>
        <CardBody className="p-10 text-center">
          <p className="font-mono text-[12px] uppercase tracking-[0.14em] text-muted">Not built yet</p>
          <p className="font-sans font-semibold text-[24px] mt-2 tracking-[-0.01em]">
            Coming once we wire the <em className="text-signal not-italic">backend</em>.
          </p>
