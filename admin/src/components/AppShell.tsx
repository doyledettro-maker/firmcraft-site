...
import { LayoutGrid, Users, Settings, ClipboardList, Bell, LifeBuoy, Activity, HeartPulse, Handshake, Send, Menu, X, BarChart3, Inbox, BookOpenCheck, Map, ShieldAlert, Target } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/playbook', label: 'Playbook', icon: BookOpenCheck },
  { href: '/outreach', label: 'Outreach', icon: Send },
  { href: '/analytics', label: 'Analytics', icon: BarChart3 },
  { href: '/health', label: 'Client Health', icon: HeartPulse },
